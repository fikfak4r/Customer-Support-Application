namespace CustomerSupport.Administration {
    ...
    export namespace LocationRow {
        ...
        ['LocationId', 'AccountId', 'Date', 'PhoneNumber', 'Email', 'Website', 'LocationName', 'Address', 'UserId', 'AccountDate', 'AccountCompanyName', 'AccountAddress', 'AccountEmail', 'AccountPhoneNumber', 'AccountWebsiteAddress', 'IsVisible'].forEach(x => (<any>Fields)[x] = x);
    }
}
