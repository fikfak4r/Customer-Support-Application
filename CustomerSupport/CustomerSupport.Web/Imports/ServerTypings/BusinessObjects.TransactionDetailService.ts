namespace CustomerSupport.BusinessObjects {
    export namespace TransactionDetailService {
        export const baseUrl = 'BusinessObjects/TransactionDetail';
        ...
        export declare function Update(request: TransactionDetailSaveRequest<TransactionDetailRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        ...
        ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(x => {
            (<any>TransactionDetailService)[x] = function (r, s, o) { return Q.serviceRequest(baseUrl + '/' + x, r, s, o); };
