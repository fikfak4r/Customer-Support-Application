    ...
    public static class Views
    {
        ...
        public static class BusinessObjects
        {
            ...
            public static class Ticket
            {
                ...
                public const string ViewPage1 = "~/Modules/BusinessObjects/Ticket/ViewPage1.cshtml";
            }
        ...
        public static class Customer
        {
            public const string Customer_ = "~/Views/Customer/Customer.cshtml";
            public const string NewCustomer = "~/Views/Customer/NewCustomer.cshtml";
        }

        public static class CustomerSMS
        {
            public const string CustomerSMS_ = "~/Views/CustomerSMS/CustomerSMS.cshtml";
        }
        ...
        public static class Product
        {
            public const string NewProduct = "~/Views/Product/NewProduct.cshtml";
            public const string Product_ = "~/Views/Product/Product.cshtml";
        }
        ...
        public static class Ticket
        {
            public const string NewTicket = "~/Views/Ticket/NewTicket.cshtml";
            public const string Ticket_ = "~/Views/Ticket/Ticket.cshtml";
            public const string TicketGrid = "~/Views/Ticket/TicketGrid.cshtml";
        }

        public static class Transaction
        {
            public const string NewTransaction = "~/Views/Transaction/NewTransaction.cshtml";
            public const string Transaction_ = "~/Views/Transaction/Transaction.cshtml";
        }

        public static class TransactionDetail
        {
            public const string TransactionDetail_ = "~/Views/TransactionDetail/TransactionDetail.cshtml";
        }
    }
}
