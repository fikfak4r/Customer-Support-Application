...
namespace CustomerSupport.Default.Migrations
{
	...
	public class Default_201704290535 : FluentMigrator.Migration
	{
		public override void Up()
		{
			...
			Create.ForeignKey("FK_BusinessUnits_ParentUnit")
				.FromTable("BusinessUnits").InSchema("dbo").ForeignColumns("ParentUnitId")
				.ToTable("BusinessUnits").InSchema("dbo").PrimaryColumns("UnitId");
			...
			Create.ForeignKey("FK_Contacts_UserId")
				.FromTable("Contacts").InSchema("dbo").ForeignColumns("UserId")
				.ToTable("Users").InSchema("dbo").PrimaryColumns("UserId");
			...
			Create.ForeignKey("FK_TicketProcess_Tickets")
				.FromTable("TicketProcess").InSchema("dbo").ForeignColumns("TicketID")
				.ToTable("Tickets").InSchema("dbo").PrimaryColumns("TicketID");

			Create.ForeignKey("FK_Tickets_Customers")
				.FromTable("Tickets").InSchema("dbo").ForeignColumns("CustomerID")
				.ToTable("Customers").InSchema("dbo").PrimaryColumns("CustomerID");

			Create.ForeignKey("FK_Tickets_Locations")
				.FromTable("Tickets").InSchema("dbo").ForeignColumns("LocationID")
				.ToTable("Locations").InSchema("dbo").PrimaryColumns("LocationID");
