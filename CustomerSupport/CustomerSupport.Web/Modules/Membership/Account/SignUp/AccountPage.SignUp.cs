        ...
        public ActionResult SignUp(SignUpRequest request, string acct, string loc)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                using (var uow = new UnitOfWork(connection))
                {
                    ...
                    RolePermission(connection, roleId, Administration.PermissionKeys.RoleLocation.Delete);
                    ...
                    RolePermission(connection, roleId, BusinessObjects.PermissionKeys.Ticket.Delete);
                    ...
                    RolePermission(connection, roleId, BusinessObjects.PermissionKeys.TransactionSms.Delete);
                    ...
                    RolePermission(connection, roleId, BusinessObjects.PermissionKeys.TicketSms.Delete);
                    ...
                    RolePermission(connection, roleId, BusinessObjects.PermissionKeys.TicketProcess.Delete);
                    ...
                    RolePermission(connection, roleId, BusinessObjects.PermissionKeys.Sms.Delete);
                    ...
                    RolePermission(connection, roleId, BusinessObjects.PermissionKeys.CustomerSms.Delete);
                    ...
                    RolePermission(connection, roleId, BusinessObjects.PermissionKeys.KbCategory.Delete);
                    ...
                    RolePermission(connection, roleId, BusinessObjects.PermissionKeys.KnowledgeBase.Delete);
                    ...
                    RolePermission(connection, roleId, BusinessObjects.PermissionKeys.KbCategoryLocation.Delete);
                    ...
                    RolePermission(connection, roleId, BusinessObjects.PermissionKeys.KnowledgeBaseLocation.Delete);
                    ...
                    RolePermission(connection, roleId, BusinessObjects.PermissionKeys.Transaction.Delete);
                    ...
                    RolePermission(connection, roleId, BusinessObjects.PermissionKeys.TransactionDetail.Delete);
                    ...
                    RolePermission(connection, roleId, BusinessObjects.PermissionKeys.PaymentDetail.Delete);
