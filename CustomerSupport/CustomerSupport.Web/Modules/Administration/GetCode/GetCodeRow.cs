...
namespace CustomerSupport.Administration.Entities
{
    ...
    [ConnectionKey("Default"), DisplayName("Get code"), InstanceName("Get code"), TwoLevelCached]
    [ReadPermission(Administration.PermissionKeys.GetCode)]
    [ModifyPermission(Administration.PermissionKeys.GetCode)]
    [LookupScript("Administration.GetCode")]
    public sealed class GetCodeRow : Row, IIdRow, INameRow
    {        
            #region Get Code Id
            [DisplayName("Get Code Id"), Column("GetCodeID"), Identity]
            public Int32? GetCodeId { get { return Fields.GetCodeId[this]; } set { Fields.GetCodeId[this] = value; } }
            public partial class RowFields { public Int32Field GetCodeId; }
            #endregion GetCodeId
            ...
            #region Link Code
            [DisplayName("Link Code"), Size(350), QuickSearch]
            public String LinkCode { get { return Fields.LinkCode[this]; } set { Fields.LinkCode[this] = value; } }
            public partial class RowFields { public StringField LinkCode; }
            #endregion LinkCode
                
            #region Form Code
            [DisplayName("Form Code"), Size(500)]
            public String FormCode { get { return Fields.FormCode[this]; } set { Fields.FormCode[this] = value; } }
            public partial class RowFields { public StringField FormCode; }
            #endregion FormCode
    ...
    {
    get { return Fields.GetCodeId; }
    }
        
            StringField INameRow.NameField
            {
            get { return Fields.LocationLocationName; }
            }
    ...
    : base("[dbo].[GetCode]")
    {
    LocalTextPrefix = "Administration.GetCode";
    }
    }
    #endregion RowFields
    }
