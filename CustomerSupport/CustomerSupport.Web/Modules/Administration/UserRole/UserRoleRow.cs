...
namespace CustomerSupport.Administration.Entities
{
    ...
    [LookupScript("Administration.UserRoleRow", Permission = "?")]
    public sealed class UserRoleRow : Row, IIdRow
    {
        ...
        [DisplayName("User Id"), NotNull, ForeignKey("Users", "UserId"), LeftJoin("jUser"), LookupInclude]
        public Int32? UserId
        {
        ...
        [DisplayName("Role Id"), NotNull, LookupInclude]
        public Int32? RoleId
        {
        ...
        [DisplayName("User Username"), Expression("jUser.[Username]"), LookupInclude]
