...
namespace CustomerSupport.Administration.Repositories
{
    ...
    public class RoleRepository
    {
        ...
        private class MySaveHandler : SaveRequestHandler<MyRow> {
            ...
            {
                base.AfterSave();
                //CustomerSupport.Membership.Pages.AccountController.RolePermission(Connection, Row.RoleId.Value, Administration.PermissionKeys.Administration);
            }
        ...
        private class MyDeleteHandler : DeleteRequestHandler<MyRow> {
            ...
            {
                base.OnBeforeDelete();
                //The system should delete it itself
            }
